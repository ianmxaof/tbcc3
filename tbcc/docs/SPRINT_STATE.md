...
| Secretary sales-rep Phase 1 | agent | **2026-08-17:** G2 local — phase `max_tokens` (120 intro/engage, 250 support/recovery) + Auto `enforce_brevity`; **no island deploy until operator approves**. Prior: Mistral fallback hop; G7 dropped turns; G3/G9/G11/G4. |
