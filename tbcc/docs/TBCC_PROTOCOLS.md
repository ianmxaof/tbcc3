...
| `backend/scripts/analytics_direction_snapshot.py` | On-demand Top 5 direction JSON/markdown for `/analytics-direction` |
| `GET /analytics/direction` | HTTP API for direction report (island canonical) |
