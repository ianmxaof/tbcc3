...
$copies = [ordered]@{
  ...
  "TBCC_MACRO_SEARCH_BOT_TOKEN" = "TBCC_MACRO_SEARCH_BOT_TOKEN"
  "TBCC_MACRO_SEARCH_BOT_USERNAME" = "TBCC_MACRO_SEARCH_BOT_USERNAME"
  ...
  "TBCC_BUFFER_X_LOOT_FIRST"                = "TBCC_BUFFER_X_LOOT_FIRST"
  "TBCC_BUFFER_X_SPICY_FIRST"               = "TBCC_BUFFER_X_SPICY_FIRST"
