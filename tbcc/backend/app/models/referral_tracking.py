...
class ReferralTracking(Base):
    ...
    referred_user_id = Column(BigInteger, nullable=False)  # Telegram user who clicked ref link
    referrer_user_id = Column(BigInteger, nullable=False)  # Telegram user who shared the link
