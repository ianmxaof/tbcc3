"""Default X / Buffer promo copy for AOF network channel map (caption library + relay copy blocks)."""

from __future__ import annotations

AOF_X_PROMO_TITLE_PREFIX = "X promo:"

AOF_X_PROMO_DEFAULTS: list[dict[str, str]] = [
    {
        "title": f"{AOF_X_PROMO_TITLE_PREFIX} Pipeline",
        "body": """The AOF network isn't standing still.
...
👉 AOF AI → https://t.me/+4umB83be5n41MmEx
🔥 AOF ASS → https://t.me/+gQaguoQE7eM4MzA5
...
PS: TBCC is cooking — site + LOOT v1 + sharper community tools. Stay close.""",
    },
    {
        ...
        "body": """You see the posts. You don't see the engine.
