...
AOF_X_BUFFER_ARMORY_TEMPLATES: list[dict[str, str]] = [
    ...
    {
        "text": "psy-slop hour: scarcity isn't cruelty it's filtration. {hub} · bio {allmylinks} · i'm {gravatar}",
        "image": "",
    },
    {
        "text": "every step slightly harder. that's the seduction. start {hub} · everything else {allmylinks}",
        "image": "",
    },
    {
    ...
    {
        "text": "obnoxious promo o'clock: Telegram has the gates, X has the affiliates. {affiliate} · {hub} · {allmylinks}",
        "image": "",
    },
    {
    ...
    {
        "text": "upload → gasp → share. AI undress is mainstream now. {affiliate} · full map {allmylinks}",
        "image": "",
    },
    {
