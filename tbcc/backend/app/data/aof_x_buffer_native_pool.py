...
AOF_X_BUFFER_NATIVE_POOL: list[dict[str, str]] = [
    ...
    {
        "text": "ASS lane. no explanation needed. {hub} · keys {allmylinks}",
    },
    {
        "text": "BLOWJOB lane — same hub, different appetite. {hub} · @aofsubscriptions_bot",
    },
    {
        "text": "BOP hits different when you're already inside the maze. {hub} · stack {allmylinks}",
    },
    {
