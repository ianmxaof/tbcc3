...
tbccWaitForModule('thisvid_enhancer', function () {
  (function () {
    ...
    const DEFAULTS = {
      ...
      promoProfileId: '7366294',
      useFriendMessage: true,
      friendMessage:
    ...
    function promoProfileId() {
      return String(settings.promoProfileId || '7366294').replace(/\D/g, '') || '7366294';
    }
    ...
    function mountOverlay() {
      ...
      root.innerHTML = `
        <button type="button" class="tbcc-chevron" title="TBCC ThisVid · drag up/down">TV ▸</button>
        <div class="tbcc-panel">
          <div class="tbcc-head" title="Drag up/down to reposition">
            <strong>TBCC ThisVid</strong>
    ...
    function boot() {
      ...
      console.info('[TBCC ThisVid] enhancer ready (chevron · download · meta · intel)');
    }
